...
export const TOPIC_METAS: TopicMeta[] = [
  ...
  },
  {
    ...
    shortTitle: 'Conceptos clave',
    subtitle: 'Definiciones simples de los términos que aparecen en esta plataforma.',
    shortDescription:
      'Colesterol, presión arterial, IMC, RCP y más — entienda cada término en pocas palabras.',
  },
];
